...
<body>
	...
	<section id= "main">
		<form action="<?php echo URL;?>register/register_submit" method="POST" id="form">
			<p class="field"><input type="text" name="user_name" id="login_input_name" pattern="[a-zA-Z0]" placeholder="Please enter your name (2 < chars < 30, letters only)"required></p>
			<p class="field"><input type="text" name="user_lastname" id="login_input_lastname" placeholder="Please enter your lastname (2 < chars < 60, letters only):" pattern="[a-zA-Z0]" required></p>
